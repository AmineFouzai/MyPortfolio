...
function DegreeCard(props: { degree: any; theme: any; }) {
      ...
      <Fade duration={2000} >
        <div {...card_body}>
          ...
          <div className="body-content">
            {degree.descriptions.map((sentence: string | number | boolean | React.ReactElement<any, string | React.JSXElementConstructor<any>> | Iterable<React.ReactNode> | React.ReactPortal | null | undefined) => {
              return (
